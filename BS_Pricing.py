...
S0 = st.sidebar.number_input("Spot Price", 0, 10000, 100)
K = st.sidebar.number_input("Strike Price", 0, 10000, 100)
sig = st.sidebar.number_input("Volatility", 0.0, 1.0, 0.2)
T = st.sidebar.number_input("Time to maturity (in years)", 0, 5, 1)
r = st.sidebar.number_input("Risk-Free Interest Rate", 0.0, 0.5, 0.05)
